...
positive = [num for num in list_of_nums if num >= 0]
negative = [num for num in list_of_nums if num < 0]
even = [num for num in list_of_nums if num % 2 == 0]
odd = [num for num in list_of_nums if num % 2 != 0]
